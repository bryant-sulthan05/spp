                                ...
                                <div class="card-content mt-5">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="email" class="fw-bold">Username atau Email :</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-vcard"></i></span>
                                                <input type="email" name="email" id="email" class="form-control" placeholder="Username atau Email" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group d-flex justify-content-center log">
                                            <button type="submit" name="login" class="btn login-btn fw-bold">Login</button>
                                        </div>
                                    ...
                                    <form action="" method="get">
                                        <div class="form-group reg mt-3">
                                            <p class="fw-bold mt-2 ms-auto">Belum punya akun?</p>
                                            <button type="submit" name="reg" id="reg" class="btn reg-btn me-auto ms-2 fw-bold">Daftar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
